...
#declare -a Samples=(T6tthh_350_incl_smallTree T6tthh_450_incl_smallTree)
#declare -a Samples=(ttdl_mcatnlo ttsl_mcatnlo)
declare -a Samples=(ttdl_mcatnlo ttsl_mcatnlo ttdl_lpowheg ttsl_lpowheg ttdl_lmgtau ttsl_lmgtau w1to4jets data_muo data_ele data_diel data_dimu ttV_sl ttV_dl diboson triboson data_mueg DY1to4Jtot tW_lepsl tW_lepdl ttH T6tthh_350_incl_smallTree T6tthh_450_incl_smallTree)
