...
hadd ${directory}/data_histos.root ${directory}/data_muo_histos.root ${directory}/data_ele_histos.root ${directory}/data_dimu_histos.root ${directory}/data_diel_histos.root ${directory}/data_mueg_histos.root 
...
hadd ${directory}/ttall_mcatnlo_histos.root ${directory}/ttsl_mcatnlo_histos.root ${directory}/ttdl_mcatnlo_histos.root
