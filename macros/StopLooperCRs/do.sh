...
RPATH=/nfs-7/userdata/stop/output_V00-02-21_2012_4jskim

#declare -a Samples=(ttdl_powheg ttsl_powheg w1to4jets tW_lepsl tW_lepdl)
declare -a Samples=(ttdl_lmg ttsl_lmg w1to4jets data_muo data_ele data_diel data_dimu ttV diboson triboson tWall_lep data_mueg DY1to4Jtot tW_lepsl tW_lepdl)
